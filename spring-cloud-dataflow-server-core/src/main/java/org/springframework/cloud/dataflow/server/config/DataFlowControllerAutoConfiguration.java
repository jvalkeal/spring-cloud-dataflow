...
import org.springframework.cloud.dataflow.server.controller.support.BootMetricJsonSerializer;
...
public class DataFlowControllerAutoConfiguration {
	...
	@Bean
	public MetricsController metricsController(MetricStore metricStore, StreamDefinitionRepository streamDefinitionRepository,
			DeploymentIdRepository deploymentIdRepository, AppDeployer appDeployer) {
		return new MetricsController(metricStore, streamDefinitionRepository, deploymentIdRepository, appDeployer,
