...
public class YarnContainerClusterApplication2 extends AbstractClientApplication<String, YarnContainerClusterApplication2> {
	...
	@Override
	protected YarnContainerClusterApplication2 getThis() {
		return this;
	}
	...
	public String run(String... args) {
		...
		builder.web(false);
		builder.sources(YarnContainerClusterApplication2.class, OperationProperties.class);
