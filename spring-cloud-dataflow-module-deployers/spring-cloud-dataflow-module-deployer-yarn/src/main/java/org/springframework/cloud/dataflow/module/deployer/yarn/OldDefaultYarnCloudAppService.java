 ...
 * @author Mark Fisher
 */
public class OldDefaultYarnCloudAppService implements YarnCloudAppService {

	private static final Logger logger = LoggerFactory.getLogger(OldDefaultYarnCloudAppService.class);
	...
	public OldDefaultYarnCloudAppService(String bootstrapName) {
