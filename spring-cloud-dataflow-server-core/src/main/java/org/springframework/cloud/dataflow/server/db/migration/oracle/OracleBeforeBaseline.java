...
public class OracleBeforeBaseline extends AbstractBaselineCallback {
	...
	public List<SqlCommand> dropIndexes() {
		return Arrays.asList(
				SqlCommand.from(DROP_AUDIT_RECORDS_AUDIT_ACTION_IDX_INDEX, ORA01418),
				SqlCommand.from(DROP_AUDIT_RECORDS_AUDIT_OPERATION_IDX_INDEX, ORA01418),
				SqlCommand.from(DROP_AUDIT_RECORDS_CORRELATION_ID_IDX_INDEX, ORA01418),
				SqlCommand.from(DROP_AUDIT_RECORDS_CREATED_ON_IDX_INDEX, ORA01418));
	}
