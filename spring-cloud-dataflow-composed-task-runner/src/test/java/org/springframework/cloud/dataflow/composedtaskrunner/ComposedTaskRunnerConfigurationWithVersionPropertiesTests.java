...
public class ComposedTaskRunnerConfigurationWithVersionPropertiesTests {
	...
	// 		+ "version.ComposedTest-AAA=1.0.0, "
	// 		+ "version.ComposedTest-BBB=1.0.1, "
	// 		+ "deployer.ComposedTest-AAA.memory=2048m";

	protected static final String COMPOSED_TASK_PROPS = "version.ComposedTest-AAA=1.0.0, "
			+ "version.ComposedTest-BBB=1.0.1, "
			+ "version.AAA=1.0.0, "
			+ "version.BBB=1.0.1";
	...
	public void testComposedConfiguration() throws Exception {
		...
		props.put("version.ComposedTest-AAA", "1.0.0");
