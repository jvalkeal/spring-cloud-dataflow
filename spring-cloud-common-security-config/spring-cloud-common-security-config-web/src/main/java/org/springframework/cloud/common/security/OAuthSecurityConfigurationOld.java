...
public class OAuthSecurityConfigurationOld {

	private static final Logger logger = LoggerFactory.getLogger(OAuthSecurityConfigurationOld.class);
	...
	protected HttpBasicConfigurer configure(HttpSecurity http) throws Exception {
		...
		// XXX glen, add ExceptionHandlingConfigurer configurer
