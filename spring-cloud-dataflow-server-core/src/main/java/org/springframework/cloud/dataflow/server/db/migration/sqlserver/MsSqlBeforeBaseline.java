 ...
 *
 */
public class MsSqlBeforeBaseline extends AbstractBaselineCallback {

	public final static String DROP_AUDIT_RECORDS_AUDIT_ACTION_IDX_INDEX =
			"drop index if exists AUDIT_RECORDS_AUDIT_ACTION_IDX on audit_records";

	public final static String DROP_AUDIT_RECORDS_AUDIT_OPERATION_IDX_INDEX =
			"drop index if exists AUDIT_RECORDS_AUDIT_OPERATION_IDX on audit_records";

	public final static String DROP_AUDIT_RECORDS_CORRELATION_ID_IDX_INDEX =
			"drop index if exists AUDIT_RECORDS_CORRELATION_ID_IDX on audit_records";

	public final static String DROP_AUDIT_RECORDS_CREATED_ON_IDX_INDEX =
			"drop index if exists AUDIT_RECORDS_CREATED_ON_IDX on audit_records";
	...
	public final static String RENAME_APP_REGISTRATION_TMP_TABLE =
			"sp_rename 'app_registration_tmp', 'app_registration'";
	...
	public final static String RENAME_AUDIT_RECORDS_TMP_TABLE =
			"sp_rename 'audit_records_tmp', 'audit_records'";
	...
	@Override
	public SqlCommand createTaskLockTable() {
		return SqlCommand.from(V1__Initial_Setup.CREATE_TASK_LOCK_TABLE);
	}
}
